package com.guitlog.guitlog.features.debt.presentation.rest.controller;
...
import com.guitlog.guitlog.features.debt.helper.DebtMapper;
...
import com.guitlog.guitlog.features.debt.valueObjects.DebtStatus;
...
public class DebtController {
    ...
    public DebtEntity create(@RequestBody CreateDebtRequest request) {
        DebtEntity debt = debtMapper.toEntity(request);
