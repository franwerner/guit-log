package com.guitlog.guitlog.features.budget.presentation.rest.controller;
...
import com.guitlog.guitlog.features.budget.application.CreateBudgetUseCase;
import com.guitlog.guitlog.features.budget.application.GetBudgetByIdUseCase;
import com.guitlog.guitlog.features.budget.application.GetBudgetsByUserUseCase;
...
public class BudgetController {
    ...
    public BudgetEntity create(@RequestBody CreateBudgetRequest request) {
        BudgetEntity budget = budgetMapper.toEntity(request);
