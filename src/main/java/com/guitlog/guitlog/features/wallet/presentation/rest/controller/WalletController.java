package com.guitlog.guitlog.features.wallet.presentation.rest.controller;
...
import com.guitlog.guitlog.features.wallet.helper.WalletMapper;
import com.guitlog.guitlog.features.wallet.application.CreateWalletUseCase;
import com.guitlog.guitlog.features.wallet.application.GetWalletByIdUseCase;
import com.guitlog.guitlog.features.wallet.application.GetWalletsByUserUseCase;
...
public class WalletController {
    ...
    public WalletEntity create(@RequestBody CreateWalletRequest request) {
        WalletEntity wallet = walletMapper.toEntity(request);
